...
while not game.over:
    ...
    if game.score is 10 and game.time <=0:
        ...
        mark4.draw()
        mark4.visible = True
        mark4.moveTo(hero.x,hero.y)
        fire2.moveTo(boss1.x,boss1.y)
        f2 = fire2.angleTo(mark4)
        fire2.rotateTo(f)
        fire2.rotateTowards(mark4)
        fire2.forward(6)
        fire2.move()
    ...
    if fire2.collidedWith(hero,"circle"):
        fire2.moveTo(boss1.x,boss1.y)
        fire2.visible is False
